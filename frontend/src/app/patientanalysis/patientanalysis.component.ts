...
export class PatientanalysisComponent implements OnInit {
  ...
  loadedResults: any[] = [];
  PatientData: PatientData = {  highBP: false, highChol: false, cholCheck: false, bmi: '', smoker: false, stroke: false, diabetes: '', physActivity: false, fruits: false, veggies: false, hvyAlcoholConsump: false, anyHealthcare: false, noDocbcCost: false, genHlth: '', mentHlth: '', physHlth: '', diffWalk: false, sex: false, age: '', education: '', income: '' };
